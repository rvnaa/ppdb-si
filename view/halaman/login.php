    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch justify-content-center">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="../../assets/img/avatar/icone.png" alt="logo" width="80" class="mb-3 mt-2 mx-auto d-block">
            ...
            ?>
            <form method="POST" action="../../controller/admin/login-siswa.php" class="needs-validation" novalidate="">
