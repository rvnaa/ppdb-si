          ...
          <div class="card-body">
            ...
            <form class="needs-validation" novalidate="" action="../../controller/admin/daftar.php" method="POST">
		      <div class="modal-body">
				...
				<div class="form-group">
		          ...
		          <input type="text" class="form-control" name="status_ortu" required="">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
				...
				<div class="form-group">
		          ...
		          <input type="text" class="form-control" name="status_administrasi" required="">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
            ...
            <form class="needs-validation" novalidate="" action="../../controller/admin/daftar.php" method="POST">
		      <div class="modal-body">
				...
				<div class="form-group">
		          <input type="hidden" name="status_ortu" value="1">
		          <input type="hidden" name="status_administrasi" value="1">
		        </div>
		        <br>
		        <div class="modal-footer bg-whitesmoke br">
